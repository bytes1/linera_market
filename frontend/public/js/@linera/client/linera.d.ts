...
export interface InitOutput {
  ...
  readonly inmemorywallet_read: () => any;
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h51cc366fa8fbf58b_multivalue_shim: (a: number, b: number) => [number, number];
  readonly __externref_table_dealloc: (a: number) => void;
  readonly closure2899_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure3391_externref_shim: (a: number, b: number, c: any, d: any) => void;
